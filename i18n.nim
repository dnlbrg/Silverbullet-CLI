...
const deTranslations = [
  ...
  ("aborted", "Abgebrochen."),
  ("confirm_delete", "Seite '$1' wirklich löschen?\n(j/N): "),
  ...
  ("new_draft_msg", "Seite existiert noch nicht.\nNeuer Entwurf."),
...
const enTranslations = [
  ...
  ("aborted", "Aborted."),
  ("confirm_delete", "Really delete page '$1'?\n(y/N): "),
  ...
  ("new_draft_msg", "Page does not exist yet.\nCreating new draft."),
...
proc translate*(key: string, lang: string, args: varargs[string]): string =
  ...
  if lang == "de":
    for pair in deTranslations:
      if pair[0] == key:
        result = pair[1]
        break
  elif lang == "en":
    for pair in enTranslations:
      if pair[0] == key:
        result = pair[1]
        break
